...
namespace _1.KeepFaith_Infrastructure_DataStructure
{
    public class SortAlgorithm
    {
         ...
         */
        public static int QuickSortUnit(int[] array, int left, int right)
        {
            var key = array[left];
            ...
            /*for (; left < right;)
            {
                for (;right > left && array[right] > key; right--){}
                array[left] = array[right];
                for (; array[left] <= key && left < right; left++) { }
                array[right] = array[left];
            }*/
            array[left] = key;
            return right;
        ...
        public static Array QuickSort(int[] array, int low, int high)
        {
            if (low >= high)
            {
                return null;
